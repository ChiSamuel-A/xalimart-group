...
// Fixes applied:
//   - BUG-01: VML fill #ffffff → #000000, outer div/table bg → #000000
//   - BUG-03: <div> name/role → <tr><td><span>
//   - BUG-04: Divider <div> → <table><tr><td background-color>
//   - BUG-07: line-height relative → fixed px + mso-line-height-rule:exactly
//   - BUG-08: Social spacer margin-top → <tr> spacer row
//   - object-fit removed; role="presentation" added
...
export function buildXalimartBlackV2(data: SignatureData, images: SignatureImages): string {
  ...
  <style>
    @media screen and (max-width:600px){
      table.xsig-bk2-outer{width:100%!important;}
      table.xsig-bk2-inner{width:100%!important;height:auto!important;}
      td.xsig-bk2-c1{width:110px!important;height:auto!important;}
      td.xsig-bk2-c1 img.xsig-logo{width:95px!important;height:auto!important;}
      td.xsig-bk2-c2{display:none!important;}
      td.xsig-bk2-c3{width:auto!important;}
      td.xsig-bk2-c4{width:90px!important;}
      img.xsig-photo{width:90px!important;height:130px!important;max-width:90px!important;max-height:130px!important;}
    }
    [data-ogsb] table.xsig-bk2-outer{background-color:${BG}!important;}
    [data-ogsb] table.xsig-bk2-inner{background-color:${BG}!important;}
    [data-ogsb] td{background-color:${BG}!important;}
    [data-ogsc] span,[data-ogsc] a{color:${TEXT_INFO}!important;}
  </style>

  <table role="presentation" class="xsig-bk2-outer" cellpadding="0" cellspacing="0" border="0" width="600"
    ...
    <tr>
      <td align="left" valign="top"
        ...
        <table role="presentation" class="xsig-bk2-inner" cellpadding="0" cellspacing="0" border="0"
          ...
          <tr height="180" style="height:180px;mso-line-height-rule:exactly;background-color:${BG};">
            ...
            <!-- Col 1: Photo — 160px -->
            <td class="xsig-bk2-c4" valign="top" width="160" height="180"
            ...
            <td class="xsig-bk2-c3" valign="middle" width="240" height="180"
            ...
            <td class="xsig-bk2-c2" width="10" height="180"
            ...
            <td class="xsig-bk2-c1" valign="middle" width="130" height="180"
