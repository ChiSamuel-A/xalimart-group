...
export function buildXalimartWhite(data: SignatureData, images: SignatureImages): string {
  ...
  const photo = photoBase64
    ...
    : `<table cellpadding="0" cellspacing="0" border="0" width="140"
         style="width:140px;border-radius:12px;background-color:#d8d8d8;
                border:1px solid ${DIVIDER};border-collapse:collapse;
                mso-table-lspace:0pt;mso-table-rspace:0pt;">
         <tr>
           <td width="140" height="175" align="center" valign="middle"
             style="width:140px;height:175px;font-size:0;line-height:0;background-color:#d8d8d8;">&nbsp;</td>
         </tr>
       </table>`
        ...
        <td style="padding:0;margin:0;width:100%;">
          <table cellpadding="0" cellspacing="0" border="0"
            ...
            <tr>
              ...
              <!-- Col 4: Profile photo -->
              <td valign="middle"
                style="padding:20px 12px 20px 8px;width:150px;text-align:center;">
                ${photo}
              </td>
