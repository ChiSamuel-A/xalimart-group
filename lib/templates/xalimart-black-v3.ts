// Template: Xalimart Black V3 (Outlook Fix)
// Fixes applied:
//   - BUG-01: VML fill color #ffffff → #000000, outer div/table bg → #000000
//   - BUG-04: Divider <div> → <table><tr><td background-color> (Outlook-safe)
//   - BUG-05: Dark mode protection via color-scheme + [data-ogsb]
//   - BUG-08: Social spacer margin-top → <tr> spacer row
...
export function buildXalimartBlackV3(data: SignatureData, images: SignatureImages): string {
  ...
  const photo = photoBase64
    ...
    : `<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="160"
         ...
         <tr><td width="160" height="180"
           style="width:160px;height:180px;background-color:#1a1a1a;font-size:0;line-height:0;">&nbsp;</td></tr>
       </table>`
  ...
  <div style="background-color:${BG};width:600px;max-width:600px;height:200px;
              overflow:hidden;line-height:0;font-size:0;color-scheme:dark;">
  <style>
    @media screen and (max-width:600px){
      table.xsig-bk-outer{width:100%!important;}
      table.xsig-bk-inner{width:100%!important;height:auto!important;}
      td.xsig-bk-c1{width:110px!important;height:auto!important;}
      td.xsig-bk-c1 img.xsig-logo{width:95px!important;height:auto!important;}
      td.xsig-bk-c2{display:none!important;}
      td.xsig-bk-c3{width:auto!important;}
      td.xsig-bk-c4{width:90px!important;}
      img.xsig-photo{width:90px!important;height:130px!important;max-width:90px!important;max-height:130px!important;}
    }
    /* Black template is already dark — prevent any client from inverting it */
    [data-ogsb] table.xsig-bk-outer{background-color:${BG}!important;}
    [data-ogsb] table.xsig-bk-inner{background-color:${BG}!important;}
    [data-ogsb] td{background-color:${BG}!important;}
    [data-ogsc] span,[data-ogsc] a{color:${TEXT_INFO}!important;}
  </style>

  <table role="presentation" class="xsig-bk-outer" cellpadding="0" cellspacing="0" border="0" width="600"
    ...
    <tr>
      <td align="left" valign="top"
        ...
        <table role="presentation" class="xsig-bk-inner" cellpadding="0" cellspacing="0" border="0"
          ...
          <tr height="180" style="height:180px;mso-line-height-rule:exactly;background-color:${BG};">
            ...
            <!-- Col 1: Photo — 160px -->
            <td class="xsig-bk-c4" valign="top" width="160" height="180"
            ...
            <td class="xsig-bk-c3" valign="middle" width="240" height="180"
            ...
            <td class="xsig-bk-c2" width="10" height="180"
            ...
            <td class="xsig-bk-c1" valign="middle" width="130" height="180"
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="130"
                ...
                <tr>
                  <td align="center" style="padding:0;mso-table-lspace:0pt;mso-table-rspace:0pt;">
                    <img class="xsig-tag" src="${images.taglineBl}" alt=""
                ...
                <tr>
                  <td height="6" style="height:6px;font-size:0;line-height:0;
                      mso-line-height-rule:exactly;background-color:${BG};">&nbsp;</td>
                </tr>
                <tr>
                  <td align="center" style="padding:0;mso-table-lspace:0pt;mso-table-rspace:0pt;
                                            background-color:${BG};">
