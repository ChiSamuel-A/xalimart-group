...
export function buildXalimartWhiteV2(data: SignatureData, images: SignatureImages): string {
  ...
  const photo = photoBase64
    ...
    : `<table class="xsig-photo-wrap" cellpadding="0" cellspacing="0" border="0" width="144"
         style="width:144px;background-color:#d8d8d8;border-collapse:collapse;mso-table-lspace:0pt;mso-table-rspace:0pt;">
         <tr>
           <td class="xsig-photo-td" width="144" height="180" align="center" valign="middle"
             style="width:144px;height:180px;font-size:0;line-height:0;background-color:#d8d8d8;">&nbsp;</td>
         </tr>
       </table>`
      ...
      <tr height="180" style="height:180px;mso-line-height-rule:exactly;">
        ...
        <td class="xsig-c1" valign="middle" width="130"
          ...
          <a href="https://xalimartgroup.sn" target="_blank"
            ...
            <img class="xsig-logo" src="${images.xalimartBlack}" alt="Xalimart Group" width="130" height="110"
